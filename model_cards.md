...
- Le modèle a été intialisé depuis la librairie xgboost avec les paramètres 'objective' défini à "reg:squarederror" et random_state à 42.
...
- Les métriques observées sont la Mean Absolute Error, Mean Squared Error et la R² (coefficient de détermination)
  ![MAE, RMSE, R²](ressources/metriques.png)
